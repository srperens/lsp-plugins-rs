...
fn build_upstream() {
    ...
    cc::Build::new()
        .cpp(true)
        .file("../../cpp_ref/upstream_wrapper_units.cpp")
        .include("../../cpp_ref")
        .include(dsp_inc)
        .include(dsp_priv)
        .include(common_inc)
        ...
        .flag_if_supported("-O3")
        .warnings(false)
        .compile("lsp_units_upstream_wrapper");
}
